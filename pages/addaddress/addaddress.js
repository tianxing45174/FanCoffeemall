...
Page({
  ...
  changeadd({
    ...
    let $this = detail.values;
    this.setData({
      province: $this[0].name,
      city: $this[1].name,
      county: $this[2].name,
      areaCode: $this[2].code,
      show: false
    })
    this.datacheck()
    console.log(this.data);
        ...
        if (options.type) {
          ...
          wx.request({
            ...
            data: {
              appkey: "U2FsdGVkX19WSQ59Cg+Fj9jNZPxRC5y0xB1iV06BeNA=",
              tokenString: this.data.token,
              aid: options.changeaid
            },
            success: res => {
              // console.log(res.data.result[0]);
              let myaddress = res.data.result[0]
              this.setData({
                name: myaddress.name,
                tel: myaddress.tel,
                province: myaddress.province,
                city: myaddress.city,
                county: myaddress.county,
                addressDetail: myaddress.addressDetail,
                areaCode: myaddress.areaCode,
                postalCode: myaddress.postalCode,
                isDefault: myaddress.isDefault,
                checked: myaddress.isDefault == 1 ? true : false,
                aid: myaddress.aid,
                savecheck: false
              })
            }
